...
void StandaloneSimulator::setupInitialSimulationState()
{
    ...
    RobotState yellow_robot_state1(Point(-3, 2), Vector(0, 0), Angle::zero(),
                                   AngularVelocity::zero());
    RobotState yellow_robot_state2(Point(3, 2), Vector(0, 0), Angle::zero(),
                                   AngularVelocity::zero());
    RobotState yellow_robot_state3(Point(0, 0), Vector(0, 0), Angle::zero(),
                                   AngularVelocity::zero());
