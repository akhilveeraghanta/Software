                ...
                std::shared_ptr<const PassingConfig> passing_config)
{
    ...
    return static_pass_quality * friendly_pass_rating * enemy_pass_rating *
           shoot_pass_rating * pass_speed_quality * in_region_quality * pass_up_field_rating;
}
                                  ...
                                  const Duration& enemy_reaction_time)
{
    ...
    std::transform(
        ...
        [&](Robot robot) { return calculateInterceptRisk(robot, pass, enemy_reaction_time); });
