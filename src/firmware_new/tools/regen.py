...
def generate_cubemx_code(board, ioc, codegen_dir, cubemx):
    ...
    proc = subprocess.Popen([r.Rlocation("__main__/external/cubemx/STM32CubeMX")])
...
if __name__ == '__main__':
 ...
 # # akkkkkkkk   # generate_cubemx_code(args.board, args.ioc, args.output_dir, args.cube_bin)
    ...
    proc = subprocess.Popen(["java", "-jar", r.Rlocation("__main__/external/cubemx/STM32CubeMX"), "-i",])
